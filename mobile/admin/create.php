		...
		<form action="" method="post">
			<table>
				...
				<tr> 
					...
					<td><input type="text" name="price" placeholder="Enter Your Email"></td>
					<td><input type="text" name="details" placeholder="Enter Your Skill"></td> 
					<td><input type="file" name="img" placeholder="Enter Your Skill"></td> 
				</tr>
				<tr>
